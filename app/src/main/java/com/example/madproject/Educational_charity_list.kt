...
class Educational_charity_list : Fragment() {
    ...
    override fun onCreateView(
        ...
        charityRecyclerView = view.findViewById(R.id.rv_edu_chariti_list)
        ...
        dbRef.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    val mAdapter = Edu_charity_adpter(EducationList)
                    charityRecyclerView.adapter = mAdapter

                    mAdapter.setOnItemClickListener(object : Edu_charity_adpter.onItemClickListener{
                        override fun onItemClick(position: Int){
                            val intent = Intent(requireActivity(), selected_charity::class.java)
